...
def get_attractions_for_traveler(traveler):
  ...
  for attractions in range(len(traveler_attractions)):
    if traveler_attractions[-1] == traveler_attractions[attractions]:
      interests_string += "the" + traveler_attractions[attractions] + "."
    else:
        interests_string += "the" + traveler_attractions[attractions] + ","
